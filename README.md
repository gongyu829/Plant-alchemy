...
:bouquet::cherry_blossom::white_flower::rosette::hibiscus:
...
:shaved_ice::champagne::beverage_box::ice_cube::beers:
...
:rock::mountain_snow::mountain::mount_fuji::volcano::volcano:
